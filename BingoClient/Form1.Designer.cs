namespace BingoClient
{
    ...
    int gridStartY = 120; // Adjust vertical position as needed
    ...
    int chatStartX = 400; // Adjusted to fit within the new window size
    int chatWidth = 300;
    int chatHeight = 50;
    int chatBoxY = this.ClientSize.Height - chatHeight+100; // Adjust the value as needed
    int sendButtonY = chatBoxY + chatHeight + 10; // Adjust the value as needed
    ...
    this.chatLabel.Font = new System.Drawing.Font("Segoe UI", 15, System.Drawing.FontStyle.Bold);
